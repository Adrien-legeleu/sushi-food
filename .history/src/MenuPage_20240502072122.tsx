    ...
    <div className="h-full -w-full bg-black">
      <div className="h-full w-full bg-[url('././assets/menupage.jpeg')] bg-left-bottom bg-cover flex items-center pb-24">
        ...
        <div className="flex flex-col gap-10 mt-32">
          <h1 className="text-7xl text-center font-title text-whiteTitle mb-12">
            Discover our menu !{" "}
          </h1>
          {MenuData.map((menu, index) => {
            return (
              <div key={index} className="ml-5 mr-5 ">
                ...
                <div>
                  <Splide
                    className="  w-[85%] mx-auto pb-10 pt-10"
                    options={{
                      perPage: window.innerWidth > 900 ? 3 : 2,
                      pagination: false,
                    }}
                  >
