        ...
        <div className="h-screen w-full  relative flex items-center justify-center ">
            ...
            <div className="flex items-center mt-20 w-2/3 h-[90%] relative">
                <div className="flex-1 h-[80%]">
                    <img className="w-2/3 h-full absolute top-0 left-0 rounded-3xl object-cover shadow-picture" src="./picture2.png" alt="sushi-food" />
                    <img className="w-2/3 h-full rounded-3xl object-cover shadow-picture" src="./picture3.png" alt="sushi-food" />
                    <img className="w-2/3 h-full rounded-3xl object-cover shadow-picture" src="./picture.jpeg" alt="sushi-food" />
                </div>
