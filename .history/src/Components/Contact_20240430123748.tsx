...
export const Contact =()=>{
    return(
        <div  className="h-screen w-full bg-[url('././assets/contact-fond.jpg')] bg-cover bg-bottom bg-fixed flex flex-col items-center justify-end">
            <h2 className="font-title text-4xl text-green">Contactez-nous</h2>
