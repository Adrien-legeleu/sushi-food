    ...
    return (
        <div className='fixed h-20 w-full max-w-[1400px] top-0 left-1/2 -translate-x-1/2 flex justify-between items-center pl-12 pr-12'>
            ...
            <ul className='flex items-center gap-5 justify-between text-whiteText text-xl'>
                <li className='cursor-pointer  duration-300 hover:bg-green rounded-full p-4 pt-2 pb-2'>About</li>
                <li className='cursor-pointer  duration-300 hover:bg-green rounded-full p-4 pt-2 pb-2'>Menus</li>
                <li className='cursor-pointer  duration-300 hover:bg-green rounded-full p-4 pt-2 pb-2'>Reservation</li>
            </ul>
