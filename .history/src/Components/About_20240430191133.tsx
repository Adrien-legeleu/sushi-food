export const About =()=>{
    return(
        <div className="h-screen w-full  relative flex items-center justify-center  max-w-[1800px] m-auto">
            ...
            <div className="flex items-center mt-20 lg:w-2/3 w-[95%] h-[90%] gap-10 flex-col lg:flex-row">
                ...
                <div className="flex flex-1 gap-4 flex-col text-center lg:text-start">
