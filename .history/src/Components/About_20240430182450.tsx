        ...
        <div className="h-screen w-full  relative flex items-center justify-center ">
            ...
            <div className="flex items-center mt-20 w-2/3 h-[90%]">
                <div className="flex-1 h-[80%] relative">
                    <img className="w-3/4 h-2/5 absolute top-10 left-0 rounded-3xl object-cover shadow-picture" src="./picture2.png" alt="sushi-food" />
                    <img className="w-1/2 h-1/3  bottom-10 left-1/2 absolute rounded-3xl object-cover shadow-picture" src="./picture3.png" alt="sushi-food" />
                    <img className="w-2/5 h-2/4 bottom-[10%] left-0 -rotate-6  absolute rounded-3xl object-cover shadow-picture" src="./picture.jpeg" alt="sushi-food" />
                </div>
