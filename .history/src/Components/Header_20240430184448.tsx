                ...
                <li className='cursor-pointer  duration-200 hover:bg-red rounded-full p-6 pt-2 pb-2'>Reservation</li>
                    ...
                    <div>
                        <div className='w-8 h-8 relative'>
                            <div className='absolute top-0 left-1/2 w-1 h-full rounded-full -translate-x-1/2 bg-redBG'></div>
                            <div className='absolute top-0 left-1/2 w-1 h-full rotate-90 rounded-full -translate-x-1/2 bg-redBG'></div>
                        </div>
                    </div>
                )
            }
