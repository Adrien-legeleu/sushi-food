                ...
                <li className='cursor-pointer  duration-200 hover:bg-red rounded-full p-6 pt-2 pb-2'>Reservation</li>
                    ...
                    <div className='h-full pr-5 flex items-center justify-center'>
                        <div className='w-8 h-8 relative' onClick={()=> setIsOpenMenu(!isOpenMenu)}>
                            <div className={`absolute top-1/2 left-1/2 w-1 h-full rounded-full -translate-x-1/2  -translate-y-1/2 bg-redBG ${isOpenMenu ? "rotate-90 duration-200" : 'rotate-0'}`}></div>
