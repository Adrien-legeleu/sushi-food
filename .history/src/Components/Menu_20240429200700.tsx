export const Menu = ()=>{
    return(
        <div className="h-screen w-full pl-48">
            <div className="flex items-center mt-20 w-full h-[90%] ">
                <div className="flex-1 flex gap-4 flex-col text-center">
                ...
                <div className="flex-1 h-[80%]">
                    <img className="w-2/3 h-full  rounded-3xl object-contain" src="./psd.png" alt="" />
                </div>
            </div>
        </div>
    )
