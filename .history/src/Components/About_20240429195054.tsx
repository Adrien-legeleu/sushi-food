        ...
        <div className="h-screen w-full bg-[url('././assets/fond.jpeg')]  bg-cover bg-center relative flex items-center justify-center ">
            ...
            <div className="flex items-center mt-20 w-2/3 h-[90%] ">
                ...
                <div className="flex-1 flex gap-2 flex-col">
                    ...
                    <p className="text-green text-xl font-text mt-3">SushiFood vous invite à découvrir une symphonie de saveurs exquises, où chaque plat est une exploration culinaire qui éveille les sens et transporte vos papilles au cœur du Japon.</p>
                </div>
            </div>
        </div>
    )
