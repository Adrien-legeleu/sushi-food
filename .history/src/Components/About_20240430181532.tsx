        ...
        <div className="h-screen w-full  relative flex items-center justify-center ">
            ...
            <div className="flex items-center mt-20 w-2/3 h-[90%] ">
                <div className="flex-1 h-[80%]">
                    <img className="w-2/3 h-full rounded-3xl object-cover shadow-2xl shadow-picture" src="./picture2.jpeg" alt="" />
                    <img className="w-2/3 h-full rounded-3xl object-cover shadow-2xl shadow-picture" src="./picture3.jpeg" alt="" />
