export const About =()=>{
    return(
        <div className="h-screen w-full  relative flex items-center justify-center  max-w-[1800px] m-auto">
            ...
            <div className="flex items-center mt-20 md:w-2/3 w-[95%] h-[90%] gap-10 flex-col md:flex-row">
                <div className=" h-[80%] relative w-full">
                    <img className=" flex-1 w-3/4 h-2/5 absolute top-10 left-[50%] -translate-x-1/2 rounded-3xl object-cover shadow-picture" src="./picture2.png" alt="sushi-food" />
                    <img className="w-1/2 h-1/3  bottom-[20%] rotate-6 bottom-[5%] absolute rounded-3xl object-cover shadow-picture" src="./picture3.png" alt="sushi-food" />
