export const About =()=>{
    return(
        <div className="h-screen w-full  relative flex items-center justify-center  max-w-[1800px] m-auto mb-20">
            ...
            <div className="flex  items-center mt-20 sm:w-full  lg:w-2/3 w-[95%] h-[90%] gap-10 flex-col sm:flex-row">
                <div className="  flex-1 h-[80%] relative w-full max-w-[400px]">
