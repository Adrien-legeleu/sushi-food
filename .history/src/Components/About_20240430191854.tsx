export const About =()=>{
    return(
        <div className="h-screen w-full  relative flex items-center justify-center  max-w-[1800px] m-auto mb-40">
            ...
            <div className="flex  items-center mt-20 sm:w-full  lg:w-2/3 w-[95%] h-[90%] gap-10 flex-col sm:flex-row">
                <div className="  flex-1 lg:h-[80%] h-full relative w-full max-w-[400px]">
                    ...
                    <img className="w-[40%] h-2/5 bottom-[5%] left-[5%] -rotate-6  absolute rounded-3xl object-cover shadow-picture" src="./picture.jpeg" alt="sushi-food" />
                </div>
