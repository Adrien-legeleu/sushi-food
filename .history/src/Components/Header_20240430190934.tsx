    ...
    <div className="fixed h-20 w-full max-w-[1400px] top-0 left-1/2 -translate-x-1/2 flex justify-between items-center pl-2 md:pl-12 md:pr-12 z-10">
      ...
      {window.innerWidth > 800 ? (
        ...
        <div className="h-full pr-5 flex items-center justify-center">
          ...
          >
            <div
              className={`absolute top-1/2 left-1/2 w-1 h-full rounded-full -translate-x-1/2  -translate-y-1/2 bg-greenBlack duration-200 ${
                isOpenMenu ? "-rotate-90 " : "rotate-0"
              }`}
            ></div>
            <div className="absolute top-1/2 left-1/2 w-1 h-full rotate-90 rounded-full -translate-x-1/2 -translate-y-1/2 bg-greenBlack"></div>
          </div>
