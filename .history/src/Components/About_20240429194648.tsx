        ...
        <div className="h-screen w-full bg-[url('././assets/fond.jpeg')]  bg-cover bg-center relative flex items-center justify-center ">
            ...
            <div className="flex items-center mt-20 w-2/3 h-[90%] ">
                ...
                <div className="flex-1 flex gap-2 flex-col">
                    ...
                    <p className="text-red text-xl">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nulla reprehenderit sunt sit recusandae aperiam numquam ex asperiores voluptatibus, ut assumenda!</p>
                </div>
            </div>
        </div>
    )
